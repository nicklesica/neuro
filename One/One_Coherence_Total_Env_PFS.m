function One_Coherence_Total_Env_PFS(sound_1,date_1,pars,sound_2,date_2)
...
try
    ...
    all_vars = whos('-file',sprintf('%s\\Nick\\Other\\Database_Analysis\\%s\\%s.mat',...
        evalin('base','dropbox_dir')',pars.coh.dir,date_1),...
    ...
    if length(all_vars),
        ...
        IXA = load(sprintf('%s\\Nick\\Other\\Database_Analysis\\%s\\%s.mat',...
            evalin('base','dropbox_dir')',pars.coh.dir,date_1),...
